...
public final class ConstantEntity {
    ...
    public static final String ALL_BASE = "/base";
    public static final String BY_BASE_ID = "/base/{id}";
    public static final String BASES_BY_PRODUCT_ID = "/base/product/{productId}";
    ...
    public static final String PRODUCTTS = "/productots";
    ...
    public static final String CANCULAR_SUB_PRODUCCION = "/sub/produccion/cancular";
    public static final String SUB_PRODUCCION = "/sub/produccion";
    public static final String SUB_PRODUCCION_BY_ID = "/sub/produccion/{id}";
    public static final String CANCEL_SUB_PRODUCCION_BY_ID = "/sub/produccion/cancelar/{id}";

    public static final String CANCULAR_PRODUCCION = "/produccion/cancular";
    public static final String PRODUCCION = "/produccion";
    public static final String PRODUCCION_BY_ID = "/produccion/{id}";
    public static final String CANCEL_PRODUCCION_BY_ID = "/produccion/cancelar/{id}";
